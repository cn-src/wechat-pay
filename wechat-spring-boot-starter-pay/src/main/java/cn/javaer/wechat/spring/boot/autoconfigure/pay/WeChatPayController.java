...
import cn.javaer.wechat.pay.model.notify.NotifyResultResponse;
...
public class WeChatPayController {
    ...
    public NotifyResultResponse notifyResult(@RequestBody final PaymentNotifyResult paymentNotifyResult) {
